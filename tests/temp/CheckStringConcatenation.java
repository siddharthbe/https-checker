...
class CheckStringConcatenation{
    ...
    void test() throws MalformedURLException {
        @StartsWith({"https", "path"}) String s1 = "https";
    ...
    void good(@StartsWith({"https", "path"}) String s1, String s2) throws MalformedURLException {
        URL url = new URL(s1 + s2);
    }

    void bad(@StartsWith({"https", "path"}) String s1, String s2) throws MalformedURLException {
